---
description: 'Beast Mode Chat Mode - An advanced AI agent mode for autonomous problem solving and code generation.'
model: GPT-4.1
tools: ['runCommands', 'runTasks', 'edit', 'search', 'new', 'extensions', 'runTests', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'context7', 'deepwiki', 'memory', 'microsoft-docs', 'playwright', 'sequentialthinking']
---
